...
const pdfDocument = ( texto : infoPDF) =>{
    ...
    <Document>
        ...
        <View style={styles.dadosFormulario}>
            ...
            <Text>{`Quantidade de Paletes: ${texto.quantidadePaletes}`} paletes</Text>
        ...
        <View style={styles.rodape}>
            <Text><Link style={styles.link} src='https://www.egiquimica.com/'>Visite a nossa pagina</Link></Text>
        </View>
        </Page>
    </Document>)
}
...
function PDFcomponent( props : infoPDF) {
    ...
    <div>
        ...
        <div>
            <Button type='primary'>
                <PDFDownloadLink document={pdfDocument(props)} fileName={`Form-${dataAtual}.pdf`}>
